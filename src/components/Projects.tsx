...
const projects = [
  {
    ...
    description: 'Intuitive Android investment app with SIP, Step-Up, Lumpsum, and SWP calculators enabling seamless user interactions and accurate financial projections with in-app educational module',
    tech: ['Kotlin', 'XML', 'RecyclerView', 'ViewPager2', 'Fragments', 'View Binding'],
    github: '#',
    demo: '#',
  },
  {
    title: 'Campus Connect',
    description: 'Full-stack college engagement app with attendance tracking, timetables, notices, real-time chat community using Firebase Firestore, and AI-powered Dialogflow chatbot for student FAQs',
            ...
            >
              <div
                ...
                style={{
                  ...
                  background: 'linear-gradient(135deg, rgba(82, 149, 228, 0.3), rgba(82, 149, 228, 0.1))'
                }}
              >
              ...
              <div className="p-6">
                ...
                <p className="mb-4" style={{ color: 'rgba(255, 255, 255, 0.7)' }}>{project.description}</p>
                ...
                <div className="flex gap-4">
                  ...
                  <a
                    ...
                    style={{ borderColor: 'rgba(82, 149, 228, 1)', color: 'rgba(82, 149, 228, 1)' }}
                    onMouseEnter={(e) => {
                      e.currentTarget.style.backgroundColor = 'rgba(82, 149, 228, 1)';
